...
function BeardLibAchievementManager:init()
    ...
    local user_id = Steam and Steam.userid and Steam:userid() or EpicEntitlements and EpicEntitlements.get_account_id and EpicEntitlements:get_account_id() or "unknown"
