...
local function package_key(id)
	if type(id) == "string" then
		return Idstring(id):key()
	end
	return id and id:key()
end
...
function BeardLibPackageManager:PackageLoaded(id)
    return Global.cmp.custom_loaded_packages[package_key(id)]
end

function BeardLibPackageManager:HasPackage(id)
    return not not self.custom_packages[package_key(id)]
end
