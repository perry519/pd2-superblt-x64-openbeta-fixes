...
overrider:remember(_G, 'NPCShotgunBase')
require('lib/units/weapons/shotgun/NPCShotgunBase')
Faker:redo_class('NPCShotgunBase', 'NPCRaycastWeaponBase')
...
overrider:remember(_G, 'DartWeaponBase') -- u245
...
Faker:redo_class('DartWeaponBase', 'ProjectileWeaponBase') -- u245
